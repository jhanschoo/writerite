...
import { ActionIcon, Box, Center, createStyles, Group, Stack, Text, TextInput } from '@mantine/core';
...
const Home: NextPage = () => {
  ...
  return (
    <StandardLayout breadcrumbs={[['/app', 'Home'], ['/app/deck', 'Rooms'], [`/app/room/${slug}`, slug]]} vhHeight>
      <motion.div {...motionProps}>
        <Stack sx={{ height: "100%" }} align="center">
          <Stack mx="md" sx={({ breakpoints }) => ({ maxWidth: `${breakpoints.lg}px`, minHeight: 0, flexShrink: 1, overflowY: "scroll" })}>
