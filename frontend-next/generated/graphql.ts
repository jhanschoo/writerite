...
export type DecksQuery = { __typename?: 'Query', decks: Array<{ __typename?: 'Deck', answerLang: string, archived: boolean, description: any, editedAt: any, id: string, name: string, promptLang: string, published: boolean, descendantDecks: Array<{ __typename?: 'Deck', id: string }>, ownRecord?: { __typename?: 'UserDeckRecord', notes: any } | null }> };
