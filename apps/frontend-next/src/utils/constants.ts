...
export const NEXT_PUBLIC_GRAPHQL_HTTP = process.env
  .NEXT_PUBLIC_GRAPHQL_HTTP as string;
export const NEXT_PUBLIC_GRAPHQL_WS = process.env
  .NEXT_PUBLIC_GRAPHQL_WS as string;
