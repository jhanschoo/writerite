...
export interface Context<T extends PrismaClient = PrismaClient, U extends PubSubPublishArgsByKey = PubSubPublishArgsByKey, R extends Redis = Redis> extends YogaInitialContext {
  fetchDepth: number;
  sub?: CurrentUser;
  prisma: T;
  pubsub: PubSub<U>;
