...
openssl genpkey -algorithm RSA -out wr-dev.secp256r1.ca.private -pkeyopt rsa_keygen_bits:4096
...
openssl genpkey -algorithm RSA -out wr-dev.secp256r1.private -pkeyopt rsa_keygen_bits:4096
