...
const WrDeckDetailTemplateItem = ({ template }: Props): JSX.Element => {
  const {
  ...
  const [mutateEdit, { loading: loadingEdit }] = useMutation<
    CardEditMutation,
    CardEditMutationVariables
  >(CARD_EDIT_MUTATION, {
      ...
      <FrontBackCard
        ...
        footer={
          <FrontBackCardButtonsBox>
            ...
            <SetTemplateButton onClick={handleSetTemplate} disabled={loading}>
              Use Template
            </SetTemplateButton>
          </FrontBackCardButtonsBox>
        }
